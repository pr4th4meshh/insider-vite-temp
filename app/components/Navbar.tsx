...
const Navbar = () => {
  ...
  return (
    <>
    {/* DEFAULT NAVBAR HERE*/}
       <nav className={` ${style.nav} xxs:hidden md:block `} >
     <div className='flex' >
     <div className=' flex flex-1' >
       <Link href='/'> <Image src={logo} className='w-auto h-[60px]' alt='logo'/></Link>
      ...
      <div className='flex flex-1' >
        <ul className='flex flex-row items-center text-gray-300 text-[13px]' >
          <li><Link href={'/'} className={`${style.a}`}>Corporate Events</Link></li>
